...
import MobileHeader from "./partials/mobile-header.container";
import Header from "./partials/header.container";
  ...
  return (
    <div>
      <Head>
        ...
        <meta
          name="description"
          content="Authentication page, Updates and statistics"
        />
        <meta content="width=device-width, initial-scale=1, shrink-to-fit=no" />
        <title>PiggyAlpha</title>
      </Head>
      {/*begin::Header Mobile*/}
      <MobileHeader />
      {/*end::Header Mobile*/}
      <div className="d-flex flex-column flex-root">
        ...
        <div className="d-flex flex-row flex-column-fluid page">
          ...
          >
            ...
            {/*begin::Content*/}
            <div
              className="content d-flex flex-column flex-column-fluid justify-between"
              id="kt_content"
            >
              {/*begin::Container*/}
          ...
          <div className="d-flex align-items-center mt-5">
            <div className="symbol symbol-100 mr-5">
              <div
                ...
                style={{
                  backgroundImage: 'url("/assets2/media/users/300_21.jpg")',
                }}
              />
                  ...
                  <span className="navi-link p-0 pb-2">
                    <span className="navi-icon mr-1">
                      <span className="svg-icon svg-icon-lg svg-icon-primary">
                        {/*begin::Svg Icon | path:/metronic/theme/html/demo7/dist/assets2/media/svg/icons/Communication/Mail-notification.svg*/}
                        <svg
                ...
                <div className="symbol symbol-40 bg-light mr-3">
                  <div className="symbol-label">
                    <span className="svg-icon svg-icon-md svg-icon-success">
                      {/*begin::Svg Icon | path:/metronic/theme/html/demo7/dist/assets2/media/svg/icons/General/Notification2.svg*/}
                      <svg
                        xmlns="http://www.w3.org/2000/svg"
                        xmlnsXlink="http://www.w3.org/1999/xlink"
                        width="24px"
                ...
                <div className="symbol symbol-40 bg-light mr-3">
                  <div className="symbol-label">
                    <span className="svg-icon svg-icon-md svg-icon-warning">
                      {/*begin::Svg Icon | path:/metronic/theme/html/demo7/dist/assets2/media/svg/icons/Shopping/Chart-bar1.svg*/}
                      <svg
                        xmlns="http://www.w3.org/2000/svg"
                        xmlnsXlink="http://www.w3.org/1999/xlink"
                        width="24px"
                ...
                <div className="symbol symbol-40 bg-light mr-3">
                  <div className="symbol-label">
                    <span className="svg-icon svg-icon-md svg-icon-danger">
                      {/*begin::Svg Icon | path:/metronic/theme/html/demo7/dist/assets2/media/svg/icons/Files/Selected-file.svg*/}
                      <svg
                        xmlns="http://www.w3.org/2000/svg"
                        xmlnsXlink="http://www.w3.org/1999/xlink"
                        width="24px"
                ...
                <div className="symbol symbol-40 bg-light mr-3">
                  <div className="symbol-label">
                    <span className="svg-icon svg-icon-md svg-icon-primary">
                      {/*begin::Svg Icon | path:/metronic/theme/html/demo7/dist/assets2/media/svg/icons/Communication/Mail-opened.svg*/}
                      <svg
                        xmlns="http://www.w3.org/2000/svg"
                        xmlnsXlink="http://www.w3.org/1999/xlink"
                        width="24px"
          ...
          <div>
            ...
            <div className="d-flex align-items-center bg-light-warning rounded p-5 gutter-b">
              <span className="svg-icon svg-icon-warning mr-5">
                <span className="svg-icon svg-icon-lg">
                  {/*begin::Svg Icon | path:/metronic/theme/html/demo7/dist/assets2/media/svg/icons/Home/Library.svg*/}
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    xmlnsXlink="http://www.w3.org/1999/xlink"
                    width="24px"
            ...
            <div className="d-flex align-items-center bg-light-success rounded p-5 gutter-b">
              <span className="svg-icon svg-icon-success mr-5">
                <span className="svg-icon svg-icon-lg">
                  {/*begin::Svg Icon | path:/metronic/theme/html/demo7/dist/assets2/media/svg/icons/Communication/Write.svg*/}
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    xmlnsXlink="http://www.w3.org/1999/xlink"
                    width="24px"
            ...
            <div className="d-flex align-items-center bg-light-danger rounded p-5 gutter-b">
              <span className="svg-icon svg-icon-danger mr-5">
                <span className="svg-icon svg-icon-lg">
                  {/*begin::Svg Icon | path:/metronic/theme/html/demo7/dist/assets2/media/svg/icons/Communication/Group-chat.svg*/}
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    xmlnsXlink="http://www.w3.org/1999/xlink"
                    width="24px"
            ...
            <div className="d-flex align-items-center bg-light-info rounded p-5">
              <span className="svg-icon svg-icon-info mr-5">
                <span className="svg-icon svg-icon-lg">
                  {/*begin::Svg Icon | path:/metronic/theme/html/demo7/dist/assets2/media/svg/icons/General/Attachment2.svg*/}
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    xmlnsXlink="http://www.w3.org/1999/xlink"
                    width="24px"
